    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                {/* Left: Queue */}
                <div className="w-full lg:w-80 flex flex-col bg-surface-container-low rounded-xl border border-outline-variant overflow-hidden h-[35vh] lg:h-[calc(100vh-8rem)] lg:sticky lg:top-6">
